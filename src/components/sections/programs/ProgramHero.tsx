    ...
    return (
        <section className="relative flex min-h-[70vh] items-center overflow-hidden px-6 pt-32 text-white">
            <div
                ...
                style={{
                    backgroundImage: `url('${ngoImages.heroes.programs}')`,
                }}
            />
            ...
            <div className="relative z-10 mx-auto max-w-7xl">
                ...
                <h1 className="max-w-5xl text-5xl font-bold leading-tight md:text-7xl">
                    Creating Sustainable Community Impact Through Action
                </h1>

                <p className="mt-8 max-w-3xl text-lg leading-relaxed text-white/80">
                    Pragme India Foundation focuses on education, women empowerment,
                    healthcare, sustainability, and rural development initiatives that
